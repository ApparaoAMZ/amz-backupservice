...
public class GlobalConstants {
	...
	public static String SUB_MODULE_ANONYMIZE_INITIALIZE	= "Anonymize Initialize Sub Module";
	...
	public static String SUB_MODULE_TAGGED			= "Archival Tables Tagging Sub Module";
	public static String SUB_MODULE_ANONYMIZE		= "Anonymize Archival data Sub Module";
	...
	public static String MSG_TAGGING_DATA			= "The data available in SF_ARCHIVE is tagged. ";
