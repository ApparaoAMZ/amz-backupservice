...
public class SqlQueriesConstant {
	...
	public static String RUN_MODULE_MGMT_INSERT	= "INSERT INTO GDPR.RUN_MODULE_MGMT (RUN_ID, MODULE_NAME, SUBMODULE_NAME, MODULE_STATUS, "
			+ "MODULE_START_DATE_TIME, MODULE_END_DATE_TIME, MODULE_COMMENTS ) VALUES (?, ?, ?, ?, ?, ?, ?)";
	...
	public static String RUN_MODULE_STATUS_FETCH = "SELECT MODULE_STATUS, COUNT(*) COUNT FROM GDPR.RUN_MODULE_MGMT "
			+ " WHERE RUN_ID = ? AND MODULE_NAME = ? GROUP BY MODULE_STATUS";
	...
	public static String RUN_SUMMARY_MGMT_INSERT = "INSERT INTO GDPR.RUN_SUMMARY_MGMT (RUN_ID, CATEGORY_ID, REGION, COUNTRY_CODE, "
			+ " IMPACT_TABLE_ID, BACKUP_QUERY, DEPERSONALIZATION_QUERY, TAGGED_QUERY) VALUES (?,?,?,?, ?,?,?,?) ";
	
	public static String RUN_SUMMARY_MGMT_FETCH = "SELECT SUMMARY_ID, RUN_ID, CATEGORY_ID, COUNTRY_CODE, IMPACT_TABLE_ID, BACKUP_QUERY, "
			+ " DEPERSONALIZATION_QUERY, TAGGED_QUERY FROM GDPR.RUN_SUMMARY_MGMT WHERE RUN_ID = ? ";
